...
STACKSIZE equ 0x4000                                ; Reserve 8K for kernel startup stack
...
; L1 Page Directory for kernel memory
align 0x1000
kernel_pagetable:
    %assign i 0
    %rep 1024
...
_loader:
    ...
    ; Map the kernel in at 0 and KERNEL_VIRTUAL_BASE
    mov edx, (kernel_pagetable - KERNEL_VIRTUAL_BASE)   ; Get physical address of the kernel pagetable
